...
abstract class TransformerIterable < R , P > implements Iterable < R >
{
    final Iterator < R > iterator ( @ UseParameter final Iterable < ? extends P > iterable , @ UseParameter final Transformer < ? extends R , ? super P > transformer )
	{
