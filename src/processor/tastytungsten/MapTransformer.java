...
{
    final Map < ? extends K , ? extends V > transform ( final Collection < ? extends P > collection , @ UseParameter final Transformer < ? extends K , ? super P > keyTransformer , @ UseParameter final Transformer < ? extends V , ? super P > valueTransformer )
	{
	    Map < ? extends K , ? extends V > transformerMap = getTransformerMap ( collection , keyTransformer , valueTransformer ) ;
